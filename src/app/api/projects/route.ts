...
function mapPrisma(p: Record<string, unknown>): ProjectRecord {
  return {
    ...
    solutions: (p.solutions as string) ?? null,
    tags: (p.tags as string[]) || [],
    myRole: (p.myRole as string) ?? null,
    contributions: (p.contributions as string[]) || [],
    stackFrontend: (p.stackFrontend as string[]) || [],
    stackBackend: (p.stackBackend as string[]) || [],
    stackDatabase: (p.stackDatabase as string[]) || [],
    stackTools: (p.stackTools as string[]) || [],
...
export async function POST(req: NextRequest) {
  ...
  const payload = {
    ...
    stackFrontend: Array.isArray(body.stackFrontend) ? body.stackFrontend : [],
    stackBackend: Array.isArray(body.stackBackend) ? body.stackBackend : [],
    stackDatabase: Array.isArray(body.stackDatabase) ? body.stackDatabase : [],
    stackTools: Array.isArray(body.stackTools) ? body.stackTools : [],
...
export async function PUT(req: NextRequest) {
  ...
  const data = {
    ...
    stackFrontend: body.stackFrontend || [],
    stackBackend: body.stackBackend || [],
    stackDatabase: body.stackDatabase || [],
    stackTools: body.stackTools || [],
